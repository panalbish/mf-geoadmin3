(function () {
	...
	function ($scope, $http, $translate, gaLayers) {
        var http = $http.get('http://www.monnerat.ch' + '/marco/print/info.json?url=%2Fmarco%2Fprint'); // FIXME
	...
	$scope.getNearestScale = function (target, scales) {
        ...
        $scope.submit = function () {
            ...
            var http = $http.post(this.capabilities.createURL + '?url=%2Fmarco%2Fprint%2Fcreate.json', spec);
    ...
    module.directive('gaPrint', ['$http', '$log', '$translate', function ($http, $log, $translate) {
        return {
            restrict: 'A',
